/**
 * Fenêtre modale : confirmation d'une suspension, saisie d'un motif, remise
...
export interface DialogProps {
  ...
  width?: 'sm' | 'md';
  /**
   * Faux : ni `Échap` ni le clic sur le voile ne ferment la fenêtre.
   *
   * Réservé à **un seul cas**, celui du mot de passe temporaire : il n'existe
   * qu'à cet instant, et une fermeture réflexe le perd définitivement. Partout
   * ailleurs, une modale qui refuse `Échap` est un piège — d'où la valeur par
   * défaut `true`.
   */
  dismissible?: boolean;
  children: ReactNode;
...
export function Dialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto p-6 sm:p-10">
      {/* Voile : cliquer à côté ferme — sauf quand la fenêtre porte une valeur
          qu'on ne peut pas réafficher. */}
      <div
